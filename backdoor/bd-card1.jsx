...
const Q_KINDS = ["Software Engineer","Software Developer","Software Engineering Intern","Junior Software Engineer",
  "Entry Level Software Engineer","New Grad Software Engineer","Backend Engineer","Frontend Engineer","Full Stack Engineer",
  "Web Developer","Cloud Engineer","Site Reliability Engineer (SRE)","DevOps Engineer","Systems Engineer","Infrastructure Engineer",
  "Machine Learning Engineer","Data Engineer","AI Engineer","NLP Engineer","Security Engineer","Application Security Engineer",
  "Security Analyst","QA Engineer","Test Engineer","Software Tester","Embedded Software Engineer","iOS Developer",
  "Android Developer","Mobile App Developer","Game Developer","Tools Engineer","Firmware Engineer","Robotics Software Engineer",
  "Software Intern","Software Developer Intern","Cloud Engineering Intern","DevOps Intern","Security Engineering Intern"];
            ...
            return (
              <button key={o} type="button" onClick={()=>toggle(o)}
                style={{width:"100%", display:"flex", alignItems:"center", gap:10, padding:"9px 12px",
                  ...
                  background: on ? "#F4FBF7" : "transparent", border:"none", boxShadow:"none", cursor:"pointer", textAlign:"left"}}>
...
Object.assign(window, { Card1, QMultiSelect, Q_KINDS, Q_LEVELS, Q_TYPES });
