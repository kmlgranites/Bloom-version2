  ...
  return (
    <>
      ...
      <RQ label="Who presses send?">
        <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}}>
          <RModeOpt sel={st.mode==="review"} onClick={()=>set({mode:"review"})} tint={rT.butter} icon="✋"
            badge="RECOMMENDED" title="Manual apply" desc="I draft, you tap approve. ~90s per application."/>
      ...
      <RSub title="Before I start" tint={rT.ink}>
        ...
        <RKV k="Level & work" v={`${st.level.join(", ")} · ${st.types.join(", ")} · ${st.setting.join(", ")}`}/>
        ...
        <RKV k="Apply settings" v={`Tailoring ${st.tailoring} · ${st.mode==="auto" ? "Auto-Apply" : "Manual apply"}`}/>
      </RSub>
