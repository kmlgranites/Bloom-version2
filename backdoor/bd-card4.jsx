    ...
    <div style={{display:"grid", gridTemplateColumns:"40% 60%", background:"#fff",
      ...
      <div style={{padding:"44px 40px 48px", display:"flex", flexDirection:"column", gap:22}}>
        ...
        <div style={{border:`1px solid ${kT.hairline}`, borderRadius:12, overflow:"visible"}}>
          ...
          <KRow label="Open to in-person work?">
            <KToggle value={q.inPerson || "Yes"} options={["Yes","No"]} onChange={v=>upd({inPerson:v})}/>
          </KRow>
          ...
          <KRow label="Reliable transportation?">
            <KToggle value={q.transport || "Yes"} options={["Yes","No"]} onChange={v=>upd({transport:v})}/>
          </KRow>
